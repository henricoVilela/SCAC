                    ...
                    <div class="col-md mural" >
                      ...
                      <ul class="list-group">
                        <?php
                          ...
                          $sqlRead = "SELECT a.*, ati.* FROM aluno a, atividades_comp ati WHERE a.id_aluno = ati.id_aluno and ati.status = 0 ORDER BY status, data_envio DESC";
                          ...
                          if($countResult == 0){
                            echo "<strong>Nenhuma atividade para avaliação!</strong>";
                          }
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <div class="dadosAtividade">
                                    ...
                                    <strong>Ano: </strong> <?php echo $rs->ano;?><br>
                                    ...
                                    <form id="enviaEmail<?php echo $rs->id_atividade;?>" method="post">
                                      <div class="form-group" required>
                                        ...
                                        <input type="hidden" name="email_nome" value="<?php echo $rs->nome;?>">
                                        <input type="hidden" name="email_tipo" value="<?php echo $rs->tipo;?>">
                                        <input type="hidden" name="email_titulo" value="<?php echo $rs->titulo;?>">
                                        <input type="hidden" name="email_idAtividade" value="<?php echo $rs->id_atividade;?>">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <form id="negarAtividade<?php echo $rs->id_atividade;?>" method="post">
                                    <button form="negarAtividade<?php echo $rs->id_atividade;?>" type="submit" name="negaAtividade" value="<?php echo $rs->id_atividade;?>" class="btn btn-danger">Negar Atividade</button>
                                  </form>
                                  <button form="enviaEmail<?php echo $rs->id_atividade;?>" type="submit" name="enviarEmail" value="<?php echo $rs->id_atividade;?>" class="btn btn-primary">Enviar</button>
                                </div>
                              </div>
                            </div>
                          </div> <!-- End modal -->
